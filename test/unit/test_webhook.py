...
class TestWebhook(unittest.TestCase):
    ...
    def test_add(self):
        ...
        with patch('yookassa.client.ApiClient.request') as request_mock:
            ...
            self.assertIsInstance(params, WebhookRequest)
            self.assertEqual(params.event, "payment.succeeded")
            self.assertEqual(params.url, "https://www.merchant-website.com/notification_url")
