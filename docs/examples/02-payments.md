...
payment_order = PaymentOrderUtilities({
...
builder.set_amount({"value": 1000, "currency": Currency.RUB}) \
    ...
    .set_receipt(receipt) \
    .set_payment_order(payment_order) \
...
### Получить список платежей с фильтрацией <a name="Получить-список-платежей-с-фильтрацией"></a>
