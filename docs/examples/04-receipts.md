...
res = Receipt.create({
    ...
    "items": [
        ...
        },
        {
            ...
            "payment_subject": "commodity",
            "country_of_origin_code": "CN",
            "product_code": "00 00 00 01 00 21 FA 41 00 23 05 41 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 13 00 AB 01"
        },
    ],
    "settlements": [
        {
...
from yookassa.domain.models import Currency, ReceiptItem, Settlement, SettlementType
from yookassa.domain.helpers import ProductCode
from yookassa.domain.request import ReceiptRequestBuilder

data_matrix = "010463003407001221SxMGorvNuq6Wk91fgr92sdfsdfghfgjh"
...
builder.set_type(ReceiptType.PAYMENT) \
    ...
    .set_items([
        ...
        ReceiptItem({
            ...
            "payment_mode": "full_payment",
            "payment_subject": "commodity",
            "product_code": ProductCode(data_matrix)
        })
    ]) \
    .set_settlements([
        Settlement({
